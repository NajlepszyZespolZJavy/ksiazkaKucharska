...
public class PierogiRuskie extends Przepis {
    ...
    String instrukcje = "<html>Instrukcje:<br>" +
            ...
            "2) Ser pokruszyć ręką.<br>" +
            "3) Cebulę obrać, pokroić w kostkę i zeszklić na oleju.<br>" +
            ...
            "8) Pierogi wrzucać na wrzątek i gotować, na małej mocy palnika, w osolonej wodzie ok. 2 minut od " +
